...
// Facteurs numériques par région, positionnellement alignés avec
// `content.regions` (même ordre dans les 4 fichiers de traduction).
const REGION_FACTORS = [1, 1.08, 1.1, 1.05, 1.0];
