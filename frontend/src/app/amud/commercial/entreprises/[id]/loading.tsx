...
export default function AmudCommercialEntrepriseDetailLoading() {
  return (
    <SkeletonPage>
      <div className="mx-auto max-w-[1200px]">
        <div className="mb-lg rounded-xl border border-amud-outline-variant/30 bg-amud-surface-container-lowest p-lg">
          <div className="flex items-start gap-lg">
            <Skeleton tone="amud" className="h-20 w-20 shrink-0 rounded-xl" />
        ...
        <div className="grid grid-cols-1 gap-lg lg:grid-cols-3">
          ...
          <div className="flex flex-col gap-lg">
            <Skeleton tone="amud" className="h-72 w-full rounded-xl" />
