...
/** `/amud/marketing/home` — accueil public générique (doc: "The Professional Bridge"). */
const SECTORS = [
  {
    key: 'btp',
    span: true,
...
export default function AmudMarketingHomePage() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-amud-background text-amud-on-background">
      <MarketingNav active="home" onDeadAction={notify} />

      {/* Hero */}
      <header className="relative overflow-hidden bg-amud-surface-container-low py-24 md:py-32">
        <div
      ...
      <main className="space-y-section-gap bg-amud-background py-section-gap">
        ...
        <section className="mx-auto max-w-container-max px-margin-mobile md:px-gutter">
          <div className="grid grid-cols-1 overflow-hidden rounded-lg border border-amud-outline-variant bg-amud-surface-container-lowest shadow-sm md:grid-cols-2">
            <div className="border-b border-amud-outline-variant bg-amud-surface-container-low/50 p-12 md:border-b-0 md:border-r">
            ...
            <div className="relative overflow-hidden bg-amud-primary-container/20 p-12">
              <div
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {SECTORS.map((s) =>
              s.image ? (
                <div
                  key={s.key}
                  className={`group relative h-64 cursor-pointer overflow-hidden rounded-lg border border-amud-outline-variant bg-amud-surface-container-lowest transition-all hover:shadow-md ${
                ...
                <div
                  key={s.key}
                  className="group flex h-64 cursor-pointer flex-col justify-between rounded-lg border border-amud-outline-variant bg-amud-surface-container-lowest p-8 transition-all hover:shadow-md"
                >
          ...
          <div className="relative z-10 mx-auto max-w-container-max px-margin-mobile md:px-gutter">
            <div className="mb-12 max-w-2xl">
              ...
              <p className="mt-4 text-body-md text-amud-on-surface-variant">
                Notre méthodologie propriétaire &laquo;&nbsp;Bridge&nbsp;&raquo; garantit que chaque candidat répond aux
                standards allemands stricts avant présentation.
              </p>
            </div>
            <div className="relative flex flex-col justify-between gap-8 md:flex-row">
              ...
              {METHODOLOGY.map((m) => (
                <div
                  key={m.step}
                  className={`relative z-10 flex-1 rounded-lg border border-amud-outline-variant bg-amud-surface-container-lowest p-6 ${
