...
export default function Page(){return <div className="min-h-screen bg-surface"><TopBar title="Notifications"/><div className="pb-24 md:pb-0"><NotificationsFeed/></div></div>}
