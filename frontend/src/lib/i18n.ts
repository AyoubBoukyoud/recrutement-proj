...
const dict = {
  fr: {
    ...
    auth_intent_job_seeker: 'Je cherche un emploi',
    auth_intent_recruiter: 'Je recrute',
    ...
    phone_screen_title_recruiter: 'Accès recruteur',
    phone_screen_subtitle_recruiter:
      'Utilisez le numéro associé à votre compte recruteur. Même code à 6 chiffres, pas de mot de passe.',
    recruiter_access_pending_title: "Cet accès n'est pas encore activé",
    recruiter_access_pending_body:
      "Ce numéro n'est pas enregistré comme recruteur. Vous êtes connecté en tant que candidat.",
    recruiter_access_pending_cta: 'Continuer en tant que candidat',
  ...
  ar: {
    ...
    auth_intent_job_seeker: 'أبحث عن عمل',
    auth_intent_recruiter: 'أنا موظِّف',
    ...
    phone_screen_title_recruiter: 'وصول الموظِّفين',
    phone_screen_subtitle_recruiter: 'استخدم الرقم المرتبط بحساب الموظِّف الخاص بك. نفس الرمز المكون من 6 أرقام.',
    recruiter_access_pending_title: 'هذا الوصول غير مفعّل بعد',
    recruiter_access_pending_body: 'هذا الرقم غير مسجل كموظِّف. تم تسجيل دخولك كمرشح.',
    recruiter_access_pending_cta: 'المتابعة كمرشح',
  ...
  en: {
    ...
    auth_intent_job_seeker: "I'm looking for a job",
    auth_intent_recruiter: "I'm hiring",
    ...
    phone_screen_title_recruiter: 'Recruiter access',
    phone_screen_subtitle_recruiter: 'Use the number tied to your recruiter account. Same 6-digit code, no password.',
    recruiter_access_pending_title: "This access isn't active yet",
    recruiter_access_pending_body: "This number isn't registered as a recruiter. You're signed in as a candidate.",
    recruiter_access_pending_cta: 'Continue as a candidate',
  ...
  de: {
    ...
    auth_intent_job_seeker: 'Ich suche einen Job',
    auth_intent_recruiter: 'Ich stelle ein',
    ...
    phone_screen_title_recruiter: 'Recruiter-Zugang',
    phone_screen_subtitle_recruiter: 'Verwenden Sie die mit Ihrem Recruiter-Konto verknüpfte Nummer. Derselbe 6-stellige Code.',
    recruiter_access_pending_title: 'Dieser Zugang ist noch nicht aktiv',
    recruiter_access_pending_body: 'Diese Nummer ist nicht als Recruiter registriert. Sie sind als Kandidat angemeldet.',
    recruiter_access_pending_cta: 'Als Kandidat fortfahren',
