  ...
  if (!candidate) {
    return (
      <div className="mx-auto max-w-3xl p-6 md:p-8">
        <h1 className="text-2xl font-bold text-primary">Suivi administratif</h1>
        <p className="mt-1 text-sm text-onSurface-variant">Sélectionnez un candidat validé pour voir son suivi.</p>
  ...
  return (
    <div className="min-h-screen bg-surface pb-16">
      <header className="flex h-16 items-center gap-4 border-b border-outline-variant bg-surface px-6 md:px-8">
        ...
        <h1 className="text-lg font-bold text-primary">Suivi administratif</h1>
      </header>
      ...
      <main className="mx-auto max-w-[1200px] space-y-6 p-6 md:p-8">
        <div className="flex items-center justify-between rounded-xl border border-outline-variant bg-surface-lowest p-4 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-xs font-semibold text-onSurface-variant">Candidat sélectionné</p>
        ...
        <div className="relative overflow-hidden rounded-xl bg-primary p-6 text-onPrimary shadow-sm">
          <div className="mb-4 flex items-end justify-between">
            <h3 className="text-xl font-bold">Progression globale</h3>
            <span className="rounded bg-white/20 px-2.5 py-1 text-xs font-semibold">{completed}/{MOCK_TIMELINE.length} étapes</span>
          </div>
          ...
          <p className="mt-3 text-sm text-primary-light">{percent}% complété — relocalisation vers l&apos;Allemagne en bonne voie.</p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-[1fr_auto]">
          <section className="space-y-3">
            <h4 className="text-lg font-bold text-onSurface">Étapes du processus</h4>
          ...
          <section className="flex flex-col items-center gap-3 rounded-xl border border-outline-variant bg-surface-lowest p-5 shadow-sm">
            <span className="text-xs font-semibold text-onSurface-variant">Référence dossier</span>
